#!/usr/bin/env python3
# BenchFlow Interface for InterCode
# This file is a template for integrating InterCode with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading InterCode benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "github": "https://github.com/google-deepmind/capabilities",
            "paper": "",
            "website": ""
        }
